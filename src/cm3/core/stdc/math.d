...
version (CRuntime_DigitalMars) {
    ...
    extern (D) {
        ...
        pure int signbit(float x) {
            return (cast(short*)&(x))[1] & 0x8000;
        }

        pure int signbit(double x) {
            return (cast(short*)&(x))[3] & 0x8000;
        }

        pure int signbit(real x) {
            return (real.sizeof == double.sizeof)
                ? (cast(short*)&(x))[3] & 0x8000 : (cast(short*)&(x))[4] & 0x8000;
        }
    }
    ...
    version (MinGW) {
        ...
        extern (D) {
            pure int isfinite(float x) {
                return (fpclassify(x) & FP_NORMAL) == 0;
            }
    ...
    extern (D) pure int isnormal(float x) {
        return fpclassify(x) == FP_NORMAL;
    }

    extern (D) pure int isnormal(double x) {
        return fpclassify(x) == FP_NORMAL;
    }

    extern (D) pure int isnormal(real x) {
        return fpclassify(x) == FP_NORMAL;
    }
    ...
    extern (D) pure {
        ...
        int isfinite(double x) {
            return (__DOUBLE_BITS(x) & -1UL >> 1) < 0x7ffUL << 52;
        }

        int isfinite(real x) {
            return (real.sizeof == double.sizeof)
                ? isfinite(cast(double)x) : __fpclassifyl(x) > FP_INFINITE;
        }
        ...
        int isinf(real x) {
            return (real.sizeof == double.sizeof)
                ? isinf(cast(double)x) : __fpclassifyl(x) == FP_INFINITE;
        }
        ...
        int isnan(real x) {
            return (real.sizeof == double.sizeof)
                ? isnan(cast(double)x) : __fpclassifyl(x) == FP_NAN;
        }
    ...
    extern (D) pure int isinf(double x) {
        return __isinfl(x);
    }

    pragma(mangle, "__isinfl") pure int isinf(real x);

    extern (D) pure int isnan(float x) {
        return __isnanl(x);
    }

    extern (D) pure int isnan(double x) {
        return __isnanl(x);
    }
    ...
    extern (D) pure int signbit(real x) {
        return __signbit(x);
    }
} else version (OpenBSD) {
    enum {
    ...
    extern (D) {
        pure int fpclassify(float x) {
            return isnan(x) ? FP_NAN : isinf(x) ? FP_INFINITE : isnormal(x) ? FP_NORMAL : x == 0.0f ? FP_ZERO
                : FP_SUBNORMAL;
        }

        pure int fpclassify(double x) {
            return isnan(x) ? FP_NAN : isinf(x) ? FP_INFINITE : isnormal(x) ? FP_NORMAL : x == 0.0 ? FP_ZERO
                : FP_SUBNORMAL;
        }

        pure int fpclassify(real x) {
            return isnan(x) ? FP_NAN : isinf(x) ? FP_INFINITE : isnormal(x) ? FP_NORMAL : x == 0.0L ? FP_ZERO
                : FP_SUBNORMAL;
        }
...
version (CRuntime_Microsoft) {
    ...
    extern (D) real acosl()(real x) {
        return acos(cast(double)x);
    }
    ...
    extern (D) real asinl()(real x) {
        return asin(cast(double)x);
    }
    ...
    pure extern (D) real atanl()(real x) {
        return atan(cast(double)x);
    }
    ...
    extern (D) real atan2l()(real y, real x) {
    ...
    extern (D) pure real cosl()(real x) {
        return cos(cast(double)x);
    }
    ...
    extern (D) pure real sinl()(real x) {
    ...
    extern (D) pure real tanl()(real x) {
        return tan(cast(double)x);
    }
    ...
    extern (D) real acoshl()(real x) {
        return acosh(cast(double)x);
    }
    ...
    pure extern (D) real asinhl()(real x) {
        return asinh(cast(double)x);
    }
    ...
    extern (D) real atanhl()(real x) {
        return atanh(cast(double)x);
    }
    ...
    extern (D) real coshl()(real x) {
        return cosh(cast(double)x);
    }
    ...
    extern (D) real sinhl()(real x) {
        return sinh(cast(double)x);
    }
    ...
    extern (D) pure real tanhl()(real x) {
        return tanh(cast(double)x);
    }
    ...
    extern (D) real expl()(real x) {
        return exp(cast(double)x);
    }
    ...
    extern (D) real exp2l()(real x) {
        return exp2(cast(double)x);
    }
    ...
    extern (D) real expm1l()(real x) {
        return expm1(cast(double)x);
    }

    pure double frexp(double value, int* exp);

    extern (D) pure float frexpf()(float value, int* exp) {
        return cast(float)frexp(value, exp);
    }

    extern (D) pure real frexpl()(real value, int* exp) {
        return frexp(cast(double)value, exp);
    }
    ...
    extern (D) int ilogbl()(real x) {
        return ilogb(cast(double)x);
    }

    double ldexp(double x, int exp);

    extern (D) float ldexpf()(float x, int exp) {
        return cast(float)ldexp(x, exp);
    }

    extern (D) real ldexpl()(real x, int exp) {
        return ldexp(cast(double)x, exp);
    }
    ...
    extern (D) real logl()(real x) {
        return log(cast(double)x);
    }
    ...
    extern (D) real log10l()(real x) {
        return log10(cast(double)x);
    }
    ...
    extern (D) real log1pl()(real x) {
        return log1p(cast(double)x);
    }
    ...
    extern (D) real log2l()(real x) {
        return log2(cast(double)x);
    }
    ...
    extern (D) real logbl()(real x) {
        return logb(cast(double)x);
    }
    ...
    extern (D) real scalbnl()(real x, int n) {
        return scalbn(cast(double)x, n);
    }
    ...
    extern (D) real scalblnl()(real x, c_long n) {
        return scalbln(cast(double)x, n);
    }
    ...
    extern (D) pure real cbrtl()(real x) {
        return cbrt(cast(double)x);
    }

    pure double fabs(double x);

    extern (D) pure float fabsf()(float x) {
        return cast(float)fabs(x);
    }

    extern (D) pure real fabsl()(real x) {
        return fabs(cast(double)x);
    }
    ...
    extern (D) real hypotl(real x, real y) {
        return hypot(cast(double)x, cast(double)y);
    }
    ...
    extern (D) real powl()(real x, real y) {
        return pow(cast(double)x, cast(double)y);
    }
    ...
    extern (D) real sqrtl()(real x) {
        return sqrt(cast(double)x);
    }
    ...
    extern (D) pure real erfl()(real x) {
        return erf(cast(double)x);
    }
    ...
    extern (D) real erfcl()(real x) {
        return erfc(cast(double)x);
    }
    ...
    extern (D) real lgammal()(real x) {
        return lgamma(cast(double)x);
    }
    ...
    extern (D) real tgammal()(real x) {
        return tgamma(cast(double)x);
    }
    ...
    extern (D) pure real ceill()(real x) {
        return ceil(cast(double)x);
    }
    ...
    extern (D) pure real floorl()(real x) {
        return floor(cast(double)x);
    }
    ...
    extern (D) pure real nearbyintl()(real x) {
        return nearbyint(cast(double)x);
    }
    ...
    extern (D) pure real rintl()(real x) {
        return rint(cast(double)x);
    }
    ...
    extern (D) c_long lrintl()(real x) {
        return lrint(cast(double)x);
    }
    ...
    extern (D) long llrintl()(real x) {
        return llrint(cast(double)x);
    }
    ...
    extern (D) pure real roundl()(real x) {
        return round(cast(double)x);
    }
    ...
    extern (D) c_long lroundl()(real x) {
        return lround(cast(double)x);
    }
    ...
    extern (D) long llroundl()(real x) {
        return llround(cast(double)x);
    }
    ...
    extern (D) pure real truncl()(real x) {
        return trunc(cast(double)x);
    }
    ...
    extern (D) real fmodl()(real x, real y) {
        return fmod(cast(double)x, cast(double)y);
    }
    ...
    extern (D) real remainderl()(real x, real y) {
        return remainder(cast(double)x, cast(double)y);
    }
    ...
    extern (D) real remquol()(real x, real y, int* quo) {
        return remquo(cast(double)x, cast(double)y, quo);
    }
    ...
    extern (D) pure real copysignl()(real x, real y) {
        return copysign(cast(double)x, cast(double)y);
    }
    ...
    extern (D) pure real nanl()(char* tagp) {
        return nan(tagp);
    }
    ...
    extern (D) real nextafterl()(real x, real y) {
        return nextafter(cast(double)x, cast(double)y);
    }
    ...
    extern (D) real nexttowardl()(real x, real y) {
        return nexttoward(cast(double)x, cast(double)y);
    }
    ...
    extern (D) real fdiml()(real x, real y) {
        return fdim(cast(double)x, cast(double)y);
    }
    ...
    extern (D) pure real fmaxl()(real x, real y) {
        return fmax(cast(double)x, cast(double)y);
    }
    ...
    extern (D) pure real fminl()(real x, real y) {
        return fmin(cast(double)x, cast(double)y);
    }
    ...
    extern (D) pure real fmal()(real x, real y, real z) {
        return fma(cast(double)x, cast(double)y, cast(double)z);
    }
} else version (FreeBSD) {
    double acos(double x);
    ...
    extern (D) c_long lrintl(real x) {
        return cast(c_long)rintl(x);
    }

    pure real roundl(real x);

    extern (D) c_long lroundl(real x) {
        return cast(c_long)roundl(x);
    }

    extern (D) long llroundl(real x) {
        return cast(long)roundl(x);
    }
    ...
    extern (D) double log2(double x) {
        return log(x) * ONE_LN2;
    }

    extern (D) float log2f(float x) {
    ...
    extern (D) pure real atanl(real x) {
        return atan(cast(double)x);
    }
    ...
    extern (D) pure real asinhl(real x) {
        return asinh(cast(double)x);
    }
