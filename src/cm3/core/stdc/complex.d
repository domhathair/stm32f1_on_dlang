...
pragma(inline, true) double cimag(cdouble z) {
    return z.im;
}

pragma(inline, true) float cimagf(cfloat z) {
    return z.im;
}

pragma(inline, true) real cimagl(creal z) {
    return z.im;
}
...
pragma(inline, true) double creald(cdouble z) {
    return z.re;
}

pragma(inline, true) float crealf(cfloat z) {
    return z.re;
}

pragma(inline, true) real creall(creal z) {
    return z.re;
}
