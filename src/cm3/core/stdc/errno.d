...
version (cm3) {
    ...
    import cm3.core.stdc.limits : INT_MIN;
    ...
    enum EAGAIN = B_TO_POSIX_ERROR!(B_WOULD_BLOCK);
    enum EWOULDBLOCK = B_TO_POSIX_ERROR!(B_WOULD_BLOCK);
