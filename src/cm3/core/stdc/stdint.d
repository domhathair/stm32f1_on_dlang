...
module cm3.core.stdc.stdint;

import cm3.core.stdc.config;
import cm3.core.stdc.stddef;
import cm3.core.stdc.signal;
import cm3.core.stdc.wchar_;
...
T _typify(T)(T val) @safe pure nothrow {
    return val;
}
...
version (cm3) {
    ...
    static assert(uint8_t.sizeof == 1);
    static assert(int16_t.sizeof == 2);
    static assert(uint16_t.sizeof == 2);
    static assert(int32_t.sizeof == 4);
    static assert(uint32_t.sizeof == 4);
    static assert(int64_t.sizeof == 8);
